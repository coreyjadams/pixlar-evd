...
namespace pixevd {
  ...
  void Voxel3DMeta::update(size_t xnum, size_t ynum, size_t znum) {
    ...
    if(empty())
      throw pixlar_exception("Empty voxel volume definition cannot be updated with new voxel counts!");
    
    if(xnum == kINVALID_SIZE || xnum == 0)
      throw pixlar_exception("Voxel3DMeta::Set x voxel count not set!");
    
    if(ynum == kINVALID_SIZE || ynum == 0)
      throw pixlar_exception("Voxel3DMeta::Set y voxel count not set!");
    
    if(znum == kINVALID_SIZE || znum == 0)
      throw pixlar_exception("Voxel3DMeta::Set z voxel count not set!");
  ...
  {
    if(!_valid) throw pixlar_exception("Voxel3DMeta::ID cannot be called on invalid meta!");
  ...
  {
    if(!_valid) throw pixlar_exception("Voxel3DMeta::pos cannot be called on invalid meta!");
    if(id >= _num_element) throw pixlar_exception("Voxel3DMeta::pos invalid VoxelID_t!");
  ...
  {
    if(!_valid) throw pixlar_exception("Voxel3DMeta::pos_x cannot be called on invalid meta!");
    if(id >= _num_element) throw pixlar_exception("Voxel3DMeta::pos_x invalid VoxelID_t!");
  ...
  {
    if(!_valid) throw pixlar_exception("Voxel3DMeta::pos_y cannot be called on invalid meta!");
    if(id >= _num_element) throw pixlar_exception("Voxel3DMeta::pos_y invalid VoxelID_t!");
  ...
  {
    if(!_valid) throw pixlar_exception("Voxel3DMeta::pos_z cannot be called on invalid meta!");
    if(id >= _num_element) throw pixlar_exception("Voxel3DMeta::pos_z invalid VoxelID_t!");
