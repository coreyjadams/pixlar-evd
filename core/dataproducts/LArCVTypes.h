 ...
 * \ingroup core_Base
 * 
 * \brief basic typedefs and enums (pixevd::Point2D, pixevd::msg, etc.)
 *
...
/**
   \namespace pixevd
   C++ namespace for developping LArTPC software interface to computer vision software (pixevd)
*/
namespace pixevd {
  ...
  /// Namespace for pixevd message related types
  namespace msg {
