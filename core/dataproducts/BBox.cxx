...
namespace pixevd {
  ...
  {
    if(xmin > xmax) throw pixlar_exception("xmin > xmax not allowed for BBox2D construction!");
    if(ymin > ymax) throw pixlar_exception("ymin > ymax not allowed for BBox2D construction!");
  }

  void BBox2D::update(double xmin, double ymin, double xmax, double ymax, ProjectionID_t id)
  {
    if(xmin > xmax) throw pixlar_exception("xmin > xmax not allowed for BBox2D::Update!");
    if(ymin > ymax) throw pixlar_exception("ymin > ymax not allowed for BBox2D::Update!");
  ...
  {
    if(xmin > xmax) throw pixlar_exception("xmin > xmax not allowed for BBox3D construction!");
    if(ymin > ymax) throw pixlar_exception("ymin > ymax not allowed for BBox3D construction!");
    if(zmin > zmax) throw pixlar_exception("zmin > zmax not allowed for BBox3D construction!");
  }
  ...
  void BBox3D::update(double xmin, double ymin, double zmin,
		      double xmax, double ymax, double zmax)
  {
    if(xmin > xmax) throw pixlar_exception("xmin > xmax not allowed for BBox3D::Update!");
    if(ymin > ymax) throw pixlar_exception("ymin > ymax not allowed for BBox3D::Update!");
    if(zmin > zmax) throw pixlar_exception("zmin > zmax not allowed for BBox3D::Update!");
  ...
  double BBox3D::area(int axis) const
  {
    ...
    throw pixlar_exception("BBox3D::area can only take axis=[0,1,2]!");
  }
