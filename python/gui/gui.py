...
class gui(QtGui.QWidget):
  ...
  def getDrawingControlButtons(self):
    ...
    self._falseColorSelection.setChecked(True)
    self._falseColorSelection.stateChanged.emit(True)
    ...
    # Transform the wire into it's FFT
  ...
  def initUI(self):
    ...
    # Area to hold data:
    nviews = self._event_manager.io().n_views()
